...
parser.add_argument('-u', '--undistort', action="store", required=True, help="Image to undistort")
parser.add_argument('-p', '--performance', action="store", required=False, default="performance.csv", help="Performance output")
...
square_size = arguments.square / 1000 # 0.025  # Length of the side of a square in meters
...
def main():
    ...
    images = glob.glob(arguments.input + "/" + '*.jpg')
    ...
    performance.stopAndRecord(constants.PERF_UNDISTORT)
