...
\section{Classification Approach and Assumptions}
...
Images were captured at two elevations (AGL): 20cm \& 1m, approximating the camera position of a ground-based system (towed or self-propelled). While it is unrealistic to acquire images at such low altitudes for an entire field, the development of a machine learning model requires only a small subset of the field, and these images allow ground truth to be established just by image inspection. 
