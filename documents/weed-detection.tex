...
\begin{enumerate}
	...
	\item{Is classification affected by developmental changes in vegetation across the season?}
...
\end{figure}
 ...
 Table \ref{table:seasonality-texture} shows a breakdown of the seasonality of each parameter seen in Table \ref{table:results-texture}. The results presented are a bit mixed, as no set of parameters was drawn exclusively from parameters that do not have a seasonal aspect. The highest AUC, in fact, was seen with Random Forest, where three of the four parameters exhibited change across the growth cycle.
