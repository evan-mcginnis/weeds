...
\begin{versionhistory}
  \vhEntry{1.0}{4 Mar 2025}{EM}{Initial revision for review}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption[Before and after segmentation]{Before and after segmentation. Note the absence of the stems seen in the weed in the lower portion of~\ref{fig:original-masked} -- this is made a bit more obvious with a close examination of the mask shown in~\ref{fig:mask}.}
...
\begin{enumerate}
	...
	\item{Common Purslane (Portulaca oleracea): A low-growing annual with succulent leaves that can form dense mats, particularly in irrigated fields. This weed exhibits a red color in the stems}
	...
	\item{Spotted Spurge (Euphorbia maculata): A low-growing annual that spreads quickly and is often found in disturbed soils. As the name implies, this weed features red leaf spots \parencite{Davis2009-sk}}
\end{enumerate}
...
\begin{enumerate}
	\item{An image is acquired from the set collected in the field and manually corrected.}
	...
	\item{Data for forming a model is produced with the manual class assignments. The extracted features are not manipulated.}
\end{enumerate}
...
The result of this pipeline is not the actual model itself, as it has all extracted attributes, but is the data that can them be form a model.
...
\end{equation}
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{./figures/shape-problem.jpg}
	\caption[Shape of some objects cannot be determined]{In this image of the planting bed from the perspective approximating a ground system, the shape of some objects at the edge of the image cannot be accurately determined.}
