...
\begin{versionhistory}
  ...
  \vhEntry{1.2}{30 Nov 2023}{EM}{Incorporate comments and remove lettuce references. Revise introduction and add section on color correction.}
  \vhEntry{1.3}{5 Dec 2023}{EM}{Add text on observing over growth cycle to introduction.}
  \vhEntry{1.4}{20 Dec 2023}{EM}{Change references to cantaloupe from spinach}
  \vhEntry{1.5}{2 Apr 2024}{EM}{Update dates in academic plan}
\end{versionhistory}
\newpage
}
